...
#### `udb.py` was not built written by me, credits go to @IbrahimEllahi
#### The import of [`get_data`](https://github.com/khyreek/Student-Assistance-Bot/blob/master/udb.py#L4) was written by @tejveeer
